...
description: 使用 MiniMax API 在 Codex 中完成音色克隆和克隆音色口播生成。用户提供 60-120 秒干净人声录音、可选 5-30 秒示例音频和口播文稿，skill 自动上传录音、ASR 转录示例音频、等待用户校对、创建 voice_id，并用 voice_id 按逐句情绪生成 narration.mp3。适用于“克隆我的声音”“复刻我的音色”“用我的声音生成口播”“AI 配音”等场景。
version: 1.0.0
type: voice-cloning
tags: [voice-cloning, tts, minimax, narration, codex, voice-id]
author: nyx研究所
status: experimental
---
...
先让 Codex 根据文稿生成 `out/emotion_plan.json`，再运行：
